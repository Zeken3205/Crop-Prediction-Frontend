...
import animationData from '../Assets/FarmerSmartPhone.json'; // Replace with the path to your JSON animation file

function FarmerSmartPhone() {
...
export default FarmerSmartPhone;
